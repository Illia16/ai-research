...
const savePrompt = (revisedPromptKey, revisedPromptVal, parentKey, childKey, additionalData = null) => {
  ...
  // If additionalData is provided (for images), create an object structure
  // Otherwise, revisedPromptVal is already an object (for videos)
  if (additionalData) {
    // For images: save as object with prompt and additional metadata
    data[parentKey][childKey][revisedPromptKey] = {
      prompt: revisedPromptVal,
      ...additionalData,
    };
  } else {
    // For videos: revisedPromptVal is already an object
