...
const MediaLibrary = () => {
    ...
    const getFilteredItems = () => {
        ...
        const filteredImages = imageFiles.filter((img) => {
            ...
            const matchesImageType =
                (!filters["generated-images"] &&
                    !filters["edited-images"] &&
                    !filters["variation-images"] &&
                    !filters["generated-videos"]) ||
                filters[img.imageType];

            // Check AI provider filters
            const matchesAi = (!filters.openai && !filters.geminiai) || filters[img.ai];
        ...
        const filteredVideos = videoFiles.filter((video) => {
            ...
            // Check AI provider filters
            const matchesAi = (!filters.openai && !filters.geminiai) || filters[video.ai];
                    ...
                    <div className="media-library--all">
                        ...
                        <div
                            ...
                            <div style={{ marginTop: "10px", fontSize: "14px", color: "#666" }}>
                                Showing {totalItems} of {totalAvailable} items ({filteredImages.length} images,{" "}
